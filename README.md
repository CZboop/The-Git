...
Made using the great [asciimatics package](https://github.com/peterbrittain/asciimatics).

## The Gif 📽️
Check out the animation in action:
![terminal animation of two computers with arrows moving between them, and text that says "the git happens here"](https://github.com/CZboop/The-Git/tree/main/media/the_git.gif)
